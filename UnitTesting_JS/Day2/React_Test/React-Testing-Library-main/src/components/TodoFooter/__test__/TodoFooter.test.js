...
//     describe("Rendering the correct number of incomplete tasks", () => {
//         it('should render "5 tasks left" when numberOfIncompleteTasks is 5', () => {
//             render(<MockTodoFooter numberOfIncompleteTasks={5} />);
//             const pElement = screen.getByText(/5 tasks left/i);
//             expect(pElement).toBeInTheDocument();
//         });

//         it('should render "1 task left" when numberOfIncompleteTasks is 1', () => {
...
//     describe("Additional checks for single task case (numberOfIncompleteTasks = 1)", () => {
//         beforeEach(() => {
//             render(<MockTodoFooter numberOfIncompleteTasks={1} />);
//         });

//         it('p element should be truthy', () => {
//             const pElement = screen.getByText(/1 task left/i);
//             expect(pElement).toBeTruthy();
//         });

//         it('"task" should be visible', () => {
//             const pElement = screen.getByText(/1 task left/i);
//             expect(pElement).toBeVisible();
//         });
...
//         it('p element should not be falsy', () => {
//             const pElement = screen.getByText(/1 task left/i);
//             expect(pElement).not.toBeFalsy();
//         });

//         it('should have exact text content', () => {
//             const pElement = screen.getByText(/1 task left/i);
//             expect(pElement.textContent).toBe("1 task left");
//         });
//     });
